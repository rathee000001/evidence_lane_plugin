...
The current v4.0.7 marketplace is bound to one immutable tag. From a terminal where the `codex` command is available:

```powershell
codex plugin marketplace add https://github.com/rathee000001/evidence_lane_plugin `
  --ref evidence-lane-v4.0.7-bundle-977fb5ec2702ff9d `
