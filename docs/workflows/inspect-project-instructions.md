# Understand applicable instructions
...
File provenance, override order and separately identified recall sources.

## Use it when

Use **Understand applicable instructions** when your intention matches this example:

> Show the instruction chain for this project folder.
...
1. **Inspect instruction provenance.** Inspect scoped instruction and separate workspace/host recall file hashes; never import or modify their contents. This stage is read-only.
...
Observed files do not prove what a particular Codex task actually loaded.
...
- Public skill: `inspect-project-instructions`
- Representative actions: `instructions_inspect`
