...
| 53 | `SevenZip_NSIS_extractor` | `REQUIRED_HIDDEN_RUNTIME_BINARY` | `NATIVE_RUNTIME_ASSET` | `package_local_support_bundle` | LicenseRef-7-Zip | no | `toolchains/licenses/requirements/053-sevenzip-nsis-extractor/LICENSE-RECORD.json` (`DE8D0B2FF705ADEB15E0B114D27CA43D6EC47F8DEBF258D9B1BC5F5674A6A299`) |
