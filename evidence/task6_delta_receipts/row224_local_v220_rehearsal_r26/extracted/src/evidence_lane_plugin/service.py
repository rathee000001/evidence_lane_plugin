        ...
        if normalization_transition is not None:
            ...
            if priority_interruption is not None:
                ...
                result = self.store.plan_tasks_atomic_insert(
                    ...
                    planned_by=planned_by,
                    plan_id=exact_plan_id,
                    batch_id=atomic_insertion.get("batch_id"),
                    research_batch_sha256=atomic_insertion.get(
                        "research_batch_sha256"
                    ),
                    expected_backlog_sha256=atomic_insertion.get(
                        "expected_backlog_sha256"
                    ),
                    expected_canonical_plan_sha256=atomic_insertion.get(
                        "expected_canonical_plan_sha256"
                    ),
                    expected_executable_projection_sha256=atomic_insertion.get(
                        "expected_executable_projection_sha256"
                    ),
                    expected_physical_final_task_id=atomic_insertion.get(
    ...
    def task_backlog_window(
        ...
        *,
        ...
        return {
            ...
            "plan_runtime_projection": backlog.get("plan_runtime_projection"),
        }
