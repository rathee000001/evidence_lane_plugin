...
export default function LicensePage() {
  return (
    <main className="legal shell">
      ...
      <p>Third-party libraries, platforms, names, and trademarks remain governed by their respective licenses and owners. Their inclusion does not transfer ownership of Evidence Lane, and this notice does not replace their license terms. Model and tool assistance does not create project authorship or acceptance authority.</p>
