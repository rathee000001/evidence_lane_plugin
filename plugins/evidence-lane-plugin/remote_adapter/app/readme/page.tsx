...
export default function ReadmePage() {
  return (
    <main className="legal shell repositoryDocument">
      ...
      <p>The row-46 proof loads all 18 dummy lanes, gives the GitHub Code lane a real three-commit synthetic repository and parent chain, validates initial and unchanged-Refresh packages, and produces independent forensic reports. Each public MMD/DOT pair is the engine&apos;s complete lane topology, and each 4K PNG is rendered from that exact MMD rather than from a generic four-file overview. Inspect and download the published artifacts on <Link href="/proof#dummy-lane-proofs">Proof</Link>. The separate post-acceptance real-Git test remains bound to the main Evidence Lane repository&apos;s full reachable history.</p>
      <h2>Proof law</h2>
