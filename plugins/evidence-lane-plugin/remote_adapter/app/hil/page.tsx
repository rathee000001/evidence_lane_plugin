  ...
  return (
    <main>
      ...
      <section className="legal shell hilStatusPage">
        ...
        <div className="hilStateStrip"><article><span>Accepted truth</span><strong>PV10 · generation 10</strong></article><article><span>Active work</span><strong>Unaccepted 1.5.0 candidate</strong></article><article><span>Pointer effect</span><strong>None</strong></article></div>
