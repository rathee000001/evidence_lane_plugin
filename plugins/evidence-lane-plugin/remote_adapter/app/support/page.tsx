...
export default function SupportPage() {
  return (
    <main className="legal shell">
      ...
      <p>Start with the exact Git branch and commit, deterministic package receipt, installed version, native 83-tool catalog, and post-restart acceptance receipt.</p>
