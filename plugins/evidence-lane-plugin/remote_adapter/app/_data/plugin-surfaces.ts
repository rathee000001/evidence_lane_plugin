...
export const pluginSurfaces: readonly PluginSurface[] = [
  ...
  },
  {
    ...
    family: "Session",
    description: "Prepares one accepted, sealed fresh-host continuity handoff.",
    setting: "Only user request or genuine context exhaustion makes it eligible.",
    produces: "A hash-bound Entry/Exit handoff package.",
    boundary: "An active unaccepted candidate must be resumed, not consumed as travel.",
    primaryControl: false,
  },
  {
    id: "evi-storage",
