...
export const businessGuide: readonly BusinessGuideEntry[] = [
  ...
  },
  {
    ...
    answer: "A valid 3.0.0 Codex test installation surface must show Evidence Lane, the correct icon, Praveen Rathee as the developer identity, exact version 3.0.0, a complete business description, the package-local MCP identity, 17 skills, 8 lifecycle hook events, and 87 native actions classified as 27 read and 60 write. The exact commit and package hashes must match the governed branch receipt.\n\nA pre-HIL test install does not update accepted Project Truth, merge main, or rewrite a release slot. PV14 remains a future explicit Project HIL boundary; it is not inferred from an install or branch commit. Only a fresh explicit Project HIL decision may authorize the exact accepted commit to enter a separately governed promotion route. Any mismatched page is a hard stop.",
    href: "/connect",
  },
  {
    id: "connectors",
