...
export const studioRouteContexts: readonly StudioRouteContext[] = [
  {
    ...
    currentCapability: "The public site explains the current 3.0.0 pre-HIL Codex source, its 18 evidence lanes, 17 governed skills, six primary controls, native Codex catalog, and separate accepted-PV boundary.",
  ...
  },
  {
    ...
    purpose: "Explain the 87 stable native action identities and their read, write, lifecycle, Canon, Learning, and host-capability boundaries.",
    currentCapability: "The Codex package declares one native evidence-lane server with 87 actions: 27 read-only and 60 write-capable.",
  ...
  },
  {
    ...
    currentCapability: "Codex 3.0.0 source uses the package-local native Evidence Lane server with 87 actions: 27 read-only and 60 write-capable. Current work governs only a positively proven Codex layer.",
