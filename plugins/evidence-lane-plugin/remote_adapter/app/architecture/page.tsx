    ...
    <main>
      ...
      <section className="section shell">
        ...
        <div className="compareGrid">
          ...
          <article><span className="compactDepthPill"><GlassIconOrb color="#83ddb3" size={28} decorative><OfficialToolIcon tool="terminal" size={15} decorative /></GlassIconOrb><span>87 actions</span></span><h3>Package-local MCP</h3><p>The native server exposes 27 read-only and 60 write-capable actions with explicit runtime gates.</p><Link className="textLink" href="/mcp">Open MCP <span aria-hidden="true">→</span></Link></article>
