...
_ROUTES = (
    ...
    _route(
        "live_sector_query",
        "EVIDENCE_LANE_LIVE_ROOT_CURRENT_AUTHORITY_QUERY_V2",
        "evi-source-intake",
        schema="evidence-lane.live-root-current-authority-query.v2",
        public_tools=(
            "lane_catalog",
        ...
        plan_families=("LANES", "RETRIEVAL", "CURRENT_AUTHORITY"),
        verification=(
            "CURRENT_SECTOR_REGISTRY",
            "ENV_UOP_AUTHORITY_ROLE_SEPARATION",
        ),
    ),
    _route(
        "public_actions",
        ...
        verification=(
            "CURRENT_ACTION_HOOKS_OFF_MATRIX",
            "MODEL_VISIBLE_SCHEMA_PARITY",
        ),
    ),
    _route(
        "unified_tool_workflow_architecture",
        "ONE_REGISTRY_DERIVED_INTERNAL_OUTER_SDK_ENV_UOP_TOOL_ROUTE",
        "ai_toolchain",
        ...
        verification=(
            "ONE_UNIFIED_DERIVED_TOOL_GRAPH_WITH_NO_LEGACY_EXTENSION_SPLIT",
            "ALL_CURRENT_AND_FUTURE_REGISTERED_WORKFLOWS_INHERIT_ROUTE_LAW",
            "INTERNAL_AND_OUTER_SDK_DISTINCT",
            "ENV_UOP_EXECUTABLE_DECISION_PAIRING",
            "FAST_MCP_COMPOSITION_NEVER_REPLACES_WORKING_NATIVE_STDIO",
            "CODEX_SOLE_AGENT_AUTHORITY",
            "NO_INFERRED_HIL_OR_PROJECT_AUTHORITY",
        ),
    ),
    _route(
    ...
    _route(
        ...
        plan_families=("DELTA_ENTRY", "PLAN", "CURRENT_AUTHORITY"),
        verification=(
    ...
    _route(
        ...
        plan_families=("MEMORY", "CURRENT_AUTHORITY", "CHATLINEAGE"),
        verification=(
    ...
    _route(
        ...
        "evi-instructions",
        schema="evidence-lane.live-root-current-authority-query.v2",
        plan_families=("CURRENT_AUTHORITY", "MEMORY", "LIVE_ROOT_QUERY"),
        verification=(
    ...
    _route(
        ...
        "evi-universe",
        schema="evidence-lane.live-root-current-authority-query.v2",
        plan_families=("CURRENT_AUTHORITY", "CONNECTOR", "LIVE_ROOT_QUERY"),
        verification=(
