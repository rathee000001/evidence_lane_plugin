...
WORKFLOWS = (
    _workflow('evi', 'Evidence Lane',
        ...
        skill='evidence-lane'),
    _workflow('boot', 'Open project session',
    ...
    _workflow('build', 'Execute project plan',
    ...
    _workflow('plan', 'Manage project plan',
    ...
    _workflow('source-intake', 'Manage project sources',
    ...
    _workflow('canon', 'Exchange task evidence',
    ...
    _workflow('memory', 'Manage project memory',
    ...
    _workflow('learning', 'Manage project lessons',
    ...
    _workflow('instructions', 'Inspect project instructions',
    ...
    _workflow('project-recipe', 'Configure project workflow',
    ...
    _workflow('mode', 'Classify project work',
    ...
    _workflow('brain-scaling', 'Retrieve project evidence',
    ...
    _workflow('refresh', 'Refresh project evidence',
    ...
    _workflow('plugin', 'Inspect project connectors',
    ...
    _workflow('additional-plugin', 'Configure project connector',
    ...
    _workflow('drop-additional-plugin', 'Revoke project connector',
    ...
    _workflow('toolchain', 'Select project tools',
    ...
    _workflow('storage', 'Select project storage',
    ...
    _workflow('universe', 'Inspect project evidence map',
    ...
    _workflow('bigger-universe', 'Link project evidence network',
    ...
    _workflow('state-travel', 'Handoff project work',
    ...
    _workflow('recover', 'Recover project state',
    ...
    _workflow('exit-boot', 'Close a project session',
    ...
    _workflow('lifecycle', 'Run project lifecycle',
