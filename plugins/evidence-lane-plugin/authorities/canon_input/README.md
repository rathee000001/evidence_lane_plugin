...
Current executable source package: `authorities/canon_input`. Storage: canon/canon_authority_v001.sqlite with files and schema history in canon. The package binds the canonical engine implementations listed in `runtime-binding.v4.json`.
