...
Current executable source package: `authorities/source_authority`. Storage: sources/sources_authority_v001.sqlite with files and schema history in sources. The package binds the canonical engine implementations listed in `runtime-binding.v4.json`.
