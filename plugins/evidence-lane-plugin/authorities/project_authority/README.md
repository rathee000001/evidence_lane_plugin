# project_authority source owner

Current executable source package: `authorities/project_authority`. Storage: root-pv.sqlite3 for project identity, writer fencing, lane heads and coordinated recovery only. The package binds the canonical engine implementations listed in `runtime-binding.v4.json`.
