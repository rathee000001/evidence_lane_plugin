...
Current executable source package: `authorities/chat_lineage`. Storage: chat_lineage/chat_lineage_authority_v001.sqlite with files and schema history in chat_lineage. The package binds the canonical engine implementations listed in `runtime-binding.v4.json`.
