...
const deliveryStages = [
  ...
  },
  {
    ...
    details: [
      ...
      `Install through the governed Git delivery route and verify the native ${currentProductContract.nativeMcp.totalActions}-action, ${currentProductContract.governedSkillCount}-skill catalog after reattach.`,
...
const previewChecklist = [
  ...
  "Primary navigation is exactly Home → Architecture → Lanes → Operators → Memory → Canon → AI Learning → GitHub/SDK Delivery → Skills → MCP → Hooks → Proof → Provenance → Connect → Prompt Studio → HIL.",
