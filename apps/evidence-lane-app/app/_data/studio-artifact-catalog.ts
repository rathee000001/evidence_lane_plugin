...
export const studioArtifactCatalog: readonly StudioArtifact[] = [
  {
    id: "project-readme",
    label: "Evidence Lane 3.0.0 project narrative",
    format: "Markdown",
    href: "/readme",
    identity: "release=3.0.0",
  ...
  },
  {
    ...
    label: "Evidence Lane 3.0.0 Codex capability matrix",
    format: "CSV",
    href: "/studio-artifacts/evidence-lane-capability-matrix-v300.csv",
    identity: "release=3.0.0 rows=3",
    status: "COMMITTED_PUBLIC_SAFE",
...
export const studioRetrievalServices = {
  ...
  generation: "DETERMINISTIC_REVIEWED_SYNTHESIS_NO_PUBLIC_PROVIDER_PROXY",
} as const;
